...
class SwingUpShortHorizonFOU(Task):
    ...
    def prepare_nn_input(self, obs: Any) -> ndarray:
        ...
        # (while training it is happening in the buffer already. Should it?)?
        return obs
    ...
    def prepare_mpc_input(self, obs: Any, param_nn: ndarray | None = None) -> MPCInput:
        ...
        # (Or do we want to ignore MPC Q function for the moment?)

        # TODO: I think there needs to be clarification how precisely a Task should be defined.
